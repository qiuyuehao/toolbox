...
public class ActivityVIVOProduction extends Activity {
    ...
    private final String VIVO_BROADCAST_KEY = "com.vivotouchscreen.sensortestsyna3618f";
    ...
    public void doProductionTest() {
        ...
        /* action = com.vivotouchscreen.sensortestsyna3618f */
        /* key = com.vivotouchscreen.sensortestsyna3618f */
        /* value = "0" - pass / "1" - fail */
        String result;
