...
class NativeWrapper {
    ...
    boolean onStartProductionTest(boolean b_do_nosleep, boolean b_do_rezero) {
        ...
        ret = startProductionTestJNI(b_do_nosleep, b_do_rezero);
        if(!ret){
    ...
    boolean onStopProductionTest() {
        boolean ret = stopProductionTestJNI();
        if(!ret){
            Log.e(SYNA_TAG, "NativeWrapper onStopProductionTest() fail to stop testing");
            return false;
        }
    ...
    private native boolean startProductionTestJNI(boolean do_no_sleep, boolean do_rezero);
    private native boolean stopProductionTestJNI();
    ...
    /********************************************************
     * helper functions to monitor the touch event
     *
    ...
    /********************************************************
     * helper functions check whether the channels assignment
     * is valid or not
     ********************************************************/
