 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getNumErrMsgJNI(
 ...
 */
JNIEXPORT jstring JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getErrMsgJNI(
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_clearErrMsgJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jstring JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_findSynaDevJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_setupSynaDevJNI(
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_openSynaDevJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_closeSynaDevJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jstring JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getIdentifyDataJNI(
        JNIEnv *env, jobject obj)
{
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getFirmwareIdJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getImageRowJNI(
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getImageColJNI(
        JNIEnv *env, jobject obj, jboolean is_landscape)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getButtonCntJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 * retrieve the number of 0D buttons
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getFeatureHasHybridJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getForceElecsJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jstring JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getProductIDJNI(
        JNIEnv *env, jobject obj)
{
 ...
 * retrieve the device id
 */
JNIEXPORT jstring JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getConfigIDJNI(
        JNIEnv *env, jobject obj)
{
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_startReportJNI(
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_stopReportJNI(
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_requestReportImageJNI(
...
/*
 * Function:  startProductionTestJNI
 * --------------------
 * do preparation before testing
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_startProductionTestJNI(
...
/*
 * Function:  stopProductionTestJNI
 * --------------------
 * finish the testing
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_stopProductionTestJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 *        <0, error out
 */
JNIEXPORT jint JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_runProductionTestJNI(
 ...
 *        <0, error out
 */
JNIEXPORT jint JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_runProductionTestExHighResistanceJNI(
 ...
 *        <0, error out
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_runProductionTestExTRxShortJNI(
 ...
 */
JNIEXPORT jint JNICALL Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getFwConfigSizeJNI(
        JNIEnv *env, jobject obj)
{
    /* save JNIEnv */
    g_jni_env = env;
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getFwConfigJNI(
 ...
 */
JNIEXPORT jint JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_queryTouchResponseJNI(
...
void callback_finger_down(int index, int x_pos, int y_pos)
{
    ...
    jclass clazz = (*g_jni_env)->FindClass(g_jni_env, "com/vivotouchscreen/sensortestsyna3706/NativeWrapper");
    if (clazz == 0) {
        printf_e("%s error: fail on FindClass, com/vivotouchscreen/sensortestsyna3706/NativeWrapper\n", __FUNCTION__);
        return;
    }
 ...
 */
JNIEXPORT jint JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_runRawCommandJNI(
 ...
 */
JNIEXPORT jboolean JNICALL  Java_com_vivotouchscreen_sensortestsyna3706_NativeWrapper_getPinsMappingJNI(
