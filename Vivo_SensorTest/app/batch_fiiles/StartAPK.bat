...
:: ----------------------------------------------------- ::
adb shell am force-stop com.vivotouchscreen.sensortestsyna3706
adb shell am start -a android.intent.action.MAIN -n com.vivotouchscreen.sensortestsyna3706/.MainActivity --activity-clear-task ^
