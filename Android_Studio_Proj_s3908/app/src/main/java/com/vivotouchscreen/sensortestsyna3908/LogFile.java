...
class LogFile extends LogFileManager {

    /********************************************************
     * constructor
     ********************************************************/
    LogFile(NativeWrapper lib,String version) {
     ...
     * the class LogFile is implemented as default
     ********************************************************/
    boolean onCreateLogFile() {
        return false;
    }

    boolean onAddLogData(String description) {
        return false;
    }
